...
@Component({
  ...
  imports: [LucideAngularModule, IconHeaderComponent, ServicePaymentCardComponent, CommonModule],
...
export class ServicesComponent {
  ...
  medicalServices = [
    ...
    { id: 2, name: 'Exame de Sangue', value: 80, status: true, updateat: '2025-04-02' },
    { id: 3, name: 'Raio-X', value: 120, status: true, updateat: '2025-04-03' },
    { id: 4, name: 'Ultrassonografia', value: 200, status: true, updateat: '2025-04-03' },
    { id: 5, name: 'Eletrocardiograma', value: 100, status: false, updateat: '2025-04-04' },
    { id: 6, name: 'Consulta Pediátrica', value: 160, status: true, updateat: '2025-04-04' },
